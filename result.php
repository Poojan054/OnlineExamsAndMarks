      ...
      <nav>
        <div class="row clearfix">
            <ul class="main-nav" animate slideInDown>
                ...
                {
                    echo '<li><a href="admin/logout.php"><b>LOGOUT</b></a></li>';
                }
                else
                {
                    echo '<li><a href="login.php"><b>ADMIN LOGIN</b></a></li>';
                }
                ?>
          </ul>
        </div>
...
<body>
    <header>
      ...
      <div class="main-content-header">
        <div style="text-align: center; padding: 50px; background-color: #f8d7da; border: 1px solid #f5c6cb; border-radius: 5px; margin: 20px;">
            <h2 style="color: #721c24; margin-bottom: 20px;">❌ Record Not Found</h2>
            <p style="color: #721c24; font-size: 16px; margin-bottom: 20px;">
                Sorry! No student data found with the provided Class and Roll Number.
            </p>
            <p style="color: #721c24; font-size: 14px; margin-bottom: 20px;">
                Please check your Class and Roll Number and try again.
            </p>
            <a href="index.php" style="display: inline-block; background-color: #721c24; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;">
                Back to Home
            </a>
        </div>
      </div>
