      ...
      <div class="main-content-header">
        ...
        <form method="post" enctype="multipart/form-data" action="secondstep.php">
            <table class="table1">
             ...
             <table class="table2">
             <tr>
                <th>father Name </th>   <th> Mother Name</th> <th>Mobile No</th><th>Parent Email</th><th>Your City</th>
             </tr>
                 <tr>
                 ...
                 <td><input type='email' name='email' placeholder='Parent Email' required class="box"/></td>
