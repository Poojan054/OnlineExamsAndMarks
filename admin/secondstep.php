...
{ 
    ...
    $columnCheck = mysqli_query($con, "SHOW COLUMNS FROM `student_data` LIKE 'u_email'");
    if($columnCheck && mysqli_num_rows($columnCheck) > 0)
    {
        $sql="INSERT INTO `Student_data`(`u_name`, `u_class`, `u_rollno`, `u_father`, `u_mother`, `u_mobile`, `u_email`, `u_village`, `u_image`) VALUES ('$username','$class','$rollno','$father','$mother','$mobile','$email','$village','$imagename')";
    }
    else
    {
