        ...
        <table class="table1">
         ...
         <?php
            if(isset($_POST['submit']))
            {
                ...
                {
                     ?>
                     <tr id="noRecordMessage">
                        <td colspan="7" style="text-align: center; padding: 30px; background-color: #f8d7da; border: 1px solid #f5c6cb; color: #721c24;">
                            <!-- <h3>❌ No Record Found</h3> -->
                            <p>No student data found with the provided Class and Roll Number. Please check and try again.</p>
                        </td>
                     </tr>
                     <script>
                        setTimeout(function() {
